  ...
  "spec": {
    ...
    "templates": [
      ...
      },
      {
        ...
        "container": {
          "args": [
            "kubectl apply -f /tmp/ps-custom-chaos.yaml -n {{workflow.parameters.adminModeNamespace}} |  sleep 30"
          ],
          "command": [
            "sh",
            "-c"
      ...
      },
      {
        ...
        "container": {
          "args": [
             "-file=/tmp/chaosengine-ps-custom-chaos.yaml",
             "-saveName=/tmp/engine-name"
          ],
          "image": "litmuschaos/litmus-checker:latest"
        }
