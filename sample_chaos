...
LITMUS_URL = 'http://a09669c9caed14ba6b97c3aa9fcbfff2-1386479144.us-east-1.elb.amazonaws.com:9091/'
LITMUS_USERNAME = 'admin'
LITMUS_PASSWORD = 'litmus'
LITMUS_PROJECT_ID = '5146db5d-b466-4379-a3db-c3908c1997bc'
    ...
    "templates": [
      {
        ...
        "steps": [
          ...
          [
            {
              "name": "ps-custom-chaos-4yn",
              "template": "ps-custom-chaos-4yn"
            }
          ],
          [
            {
      ...
      },
      {
        ...
        "inputs": {
          "artifacts": [
            {
              "name": "ps-custom-chaos-4yn",
              "path": "/tmp/ps-custom-chaos-4yn.yaml",
              "raw": {
        ...
        "container": {
          "args": [
            "kubectl apply -f /tmp/ps-custom-chaos-4yn.yaml -n {{workflow.parameters.adminModeNamespace}} |  sleep 30"
          ],
          "command": [
            "sh",
            "-c"
      ...
      },
      {
        ...
        "container": {
          "args": [
             "-file=/tmp/chaosengine-ps-custom-chaos-4yn.yaml",
             "-saveName=/tmp/engine-name"
          ],
          "image": "litmuschaos/litmus-checker:latest"
        }
      },
      {
        ...
        "container": {
          ...
          "args": [
            "kubectl delete chaosengine -l 'instance_id in (10dcb771-829b-4c20-8a38-6e383a6a94b6, )' -n {{workflow.parameters.adminModeNamespace}} "
          ]
        }
      }
    ],
